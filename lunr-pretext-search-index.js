...
},
{
  ...
  "number": "1.6.10",
  "title": "",
  "body": " We previously plotted the slope field for the differential equation and we noted that no analytical solution could be found. The slope field and four solutions are plotted in .   Solutions of ,    It appears that there is a solution that separates solutions that blow up to infinity from those that pass through the parabola and then tend asymptotically to as . We can use the fourth-order Runge-Kutta method to approximate.  "
}
]
