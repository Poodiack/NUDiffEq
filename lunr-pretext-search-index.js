...
},
{
  ...
  "body": " First-Order Linear Equations    To understand that any first-order linear differential equation  can be solved by multiplying each side of the equation by an integrating factor .  To understand the existence and uniqueness of solutions to first-order initial value problems.    "
},
{
  "id": "sec-linear-eq-2",
  "level": "2",
